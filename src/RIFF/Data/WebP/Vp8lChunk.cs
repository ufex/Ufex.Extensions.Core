...
/// <summary>
/// VP8L - Lossless bitstream chunk. Contains VP8L encoded image data.
/// The data is not stored in memory because it can be very large.
/// Only the offset and size are recorded for reference.
/// </summary>
internal class Vp8lChunk : Chunk
{
	/// <summary>
	/// The offset in the file where the VP8L bitstream data begins
	/// (after the chunk header).
	/// </summary>
	public long DataOffset { get; init; }

	/// <summary>
	/// The size of the VP8L bitstream data in bytes.
	/// </summary>
	public UInt32 DataSize => Size;

	public Vp8lChunk(FileReader fr) : base(fr)
	{
