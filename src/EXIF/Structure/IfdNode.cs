...
public class IfdNode : TreeNode
{
	...
	public IfdNode(Ifd ifd, ExifData exifData)
	...
	public override Visual[] Visuals => [new DataGridVisual(BuildTable(), "Tags")];

	private DynamicTableData BuildTable()
	{
		DynamicTableData table = new DynamicTableData(6, $"EXIF.{_ifd.IfdType}");
