...
internal static class BoxTypes
{
	...
	public static readonly Dictionary<string, string> Brands = new()
	{
		...
		{ "hevc", "HEIF Image Sequence (HEVC)" },
		{ "hevs", "HEIF Still Image (HEVC)" },
		{ "heim", "HEIF Image (Main Intra)" },
		{ "heio", "HEIF Image (Monochrome)" },
		{ "miaf", "MIAF" },
		{ "MiHE", "MIAF HEVC" },
		{ "MiAV", "MIAF AV1" },
		{ "MiHB", "MIAF HEVC High Bit Depth" },
		{ "MiHA", "MIAF AVC" },
		{ "mif2", "HEIF Second Edition" },
		{ "cche", "Camera Capture HEIC (Live Photo)" },
